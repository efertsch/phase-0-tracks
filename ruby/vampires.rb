...
if (employee_name && employee_age && employee_garlic_response && employee_allergies) || (employee_name && employee_age && employee_health && employee_allergies)  
	puts "Probably not a vampire"
elsif employee_name && ( !employee_age && employee_garlic_response) && employee_allergies
	puts "Probably a vampire"
elsif employee_name && ( !employee_age && employee_health) && employee_allergies
	puts "Probably a vampire"
elsif employee_name && ( !employee_age && !employee_garlic_response && !employee_health) && employee_allergies
...
#Provides how many employees are left to process
